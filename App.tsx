...
const App: React.FC = () => {
  ...
  const getBannerImage = (page: PageKey): string => {
    const banners: Record<string, string> = {
      ...
      // 會務公告
      announcement: 'https://images.unsplash.com/photo-1557804506-669a67965ba0?auto=format&fit=crop&q=80&w=1920',
      // 最新消息 (news, industry)
      news: 'https://images.unsplash.com/photo-1504711434969-e33886168f5c?auto=format&fit=crop&q=80&w=1920',
      // 研討會
      seminar: 'https://images.unsplash.com/photo-1505373877841-8d25f7d46678?auto=format&fit=crop&q=80&w=1920',
      // 活動花絮
      events: 'https://images.unsplash.com/photo-1523580494863-6f3031224c94?auto=format&fit=crop&q=80&w=1920',
      // 會員專區 (join, login)
      member: 'https://images.unsplash.com/photo-1521737604893-d14cc237f11d?auto=format&fit=crop&q=80&w=1920'
    };
